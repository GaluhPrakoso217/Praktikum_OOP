 ...
 * @author Prakoso
 */
public class GUI_Data_Penjualan extends javax.swing.JFrame {

    /**
     * Creates new form GUI_Data_Penjualan
     */
    public GUI_Data_Penjualan() {
        initComponents();
    }
 ...
 barang.penjualan =Integer.parseInt(jstok.getText());
 

 jmemo.append("DATA BARANG" + "\n");
 jmemo.append( "\n");
 jmemo.append( "\n");
 jmemo.append("Jenis         : " + barang.jenis+ "\n");
 jmemo.append("Warna        : " + barang.warna+ "\n");
 jmemo.append("Harga         : " + barang.harga+ "\n");
 jmemo.append("Pembelian  : " + barang.penjualan+ "\n");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GUI_Data_Penjualan.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new GUI_Data_Penjualan().setVisible(true);
            }
        });
    }
